...
- Signed-out first-time visitors supply name, email and phone. A deliberate confirmation POST verifies their email and reserves the whole basket. Signed-in verified accounts skip that confirmation. No billing address or participant profiles are required at this stage.
