...
const cases: Array<[string, () => unknown, string[], string[]]> = [
  ...
  ['getUpcomingCatalogueResults', () => q.getUpcomingCatalogueResults(), ['upcoming-catalogue-results', todayFloor], ['events', 'event-dates', 'categories', 'difficulties', 'locations', 'guides', 'media']],
