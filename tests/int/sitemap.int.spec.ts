...
describe('buildSitemap', () => {
  it('publishes eligible occurrence URLs, including past dates, and omits parent selectors', async () => {
    ...
    expect(urls).toContain('https://rockbusters.net/trips/kalymnos-camp/kalymnos-2026-10-12')
    expect(urls).toContain('https://rockbusters.net/trips/kalymnos-camp/kalymnos-2020-10-12')
    ...
    expect(sitemap.find((entry) => entry.url.endsWith('/kalymnos-2026-10-12'))?.lastModified)
      .toEqual(new Date('2026-01-08T03:04:05.000Z'))
    expect(sitemap.find((entry) => entry.url.endsWith('/kalymnos-2020-10-12'))?.lastModified)
      .toEqual(new Date('2026-02-02T03:04:05.000Z'))
  ...
  it('queries the public occurrence policy and paginates every collection to exhaustion', async () => {
    ...
    expect(urls).toContain('https://rockbusters.net/trips/kalymnos-camp/kalymnos-2027-10-12')
