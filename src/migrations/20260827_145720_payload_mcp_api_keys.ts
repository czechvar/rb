...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"event_dates_find" boolean DEFAULT false,
  	"event_dates_create" boolean DEFAULT false,
  	"event_dates_update" boolean DEFAULT false,
  	...
  	"difficulties_find" boolean DEFAULT false,
  	"difficulties_create" boolean DEFAULT false,
  	"difficulties_update" boolean DEFAULT false,
  	...
  	"post_categories_create" boolean DEFAULT false,
  	"post_categories_update" boolean DEFAULT false,
