...
const layoutTokens = [
  ...
  '--theme-trip-card-title-size',
  '--theme-trip-card-featured-title-size',
  '--theme-trip-card-title-weight',
  '--theme-trip-card-featured-copy-size',
  '--theme-trip-card-motion',
  '--theme-trip-card-overlay',
  '--theme-trip-card-hover-overlay',
  '--theme-eyebrow-line-width',
  '--theme-eyebrow-hero-line-width',
  '--theme-eyebrow-line-height',
  '--theme-eyebrow-gap',
  '--theme-eyebrow-hero-gap',
  '--theme-eyebrow-line-color',
  '--theme-gap',
  '--theme-section-pad',
  '--theme-card-pad',
